...
#MYLOCALDIR=$1
MYLOCALDIR=/nilab0/iacovella/myLocal
LAPACKLIB=/nilab0/iacovella/pkgSrc/tarballs/lapack-3.4.2.tgz
...
#cd opt/ATLASBuild
#/nilab0/iacovella/pkgSrc/tarballs/ATLAS/configure --prefix=$MYLOCALDIR -Fa alg -fPIC --with-netlib-lapack-tarfile=$LAPACKLIB
#make
#make install
#cd ../../../
...
# Setuptools
#cd pkgSrc/tarballs
#tar xvf setuptools-0.7.4.tar.gz
#cd setuptools-0.7.4
